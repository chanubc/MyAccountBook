...
import com.example.myaccountbook.databinding.FragmentIncomeBinding
...
class IncomeFragment_bc : Fragment() {
    ...
    private fun getdata() {
        ...
        val query = rdb.child("income").limitToLast(50)
        ...
        var getdata = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (i in snapshot.getChildren()) {
                    ...
                    var names = i.child("rmemo").getValue()
        ...
        rdb.child("income").addListenerForSingleValueEvent(getdata)
    }

    private fun initRecyclerView() {

        binding.textView4.text = "${currentMonth}월의 수입"
